      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {packages.map((pkg, i) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-6 border transition-all duration-300 hover:-translate-y-2 group ${
                pkg.popular
            ...
            >
              {pkg.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-[#39ff14] text-black text-xs font-bold rounded-full flex items-center gap-1">
              ...
              <a
                href={`https://wa.me/919700780595?text=Hi%20Nikhil!%20I'm%20interested%20in%20the%20${encodeURIComponent(pkg.name)}%20package%20(₹${pkg.price}/month).`}
                target="_blank"
        ...
        >
          <h3 className="text-xl sm:text-2xl font-bold">
            Not sure which plan? <span className="text-[#39ff14]">Try your first class FREE!</span>
          </h3>
